...
// const steps = ["checkout", "payment", "summary"];
...
const Checkout = () => {
  ...
  return (
    <div>
      ...
      <div className="wrapper py-6 pb-36">
...
const Information = () => {
  ...
  return (
    <div className="relative">
      ...
      <div>
        <h3 className="font-tenorsan text-lg">Select from saved or add new.</h3>
        <div className="mt-5 space-y-4">
          ...
          <div className="flex w-full items-center gap-4 rounded-lg border p-3">
            ...
            <div className="flex flex-grow items-center justify-between">
              <div>
                <h3 className="font-tenorsan font-semibold">Abraham Joseph</h3>
